...
- Canonical lyrics have not yet been recovered and verified.
- Detailed audio analysis, beats, sections, transitions, and high-value sync points have not yet been committed.
- Recurring character designs have not yet been locked.
- Shot list, prompts, and production stills have not yet been created.
...
After each numbered action above, update this file and any affected manifest/decision files on GitHub before continuing.
